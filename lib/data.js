...
export function getNdbCheckupRiskRates() { return load('ndb_checkup_risk_rates'); }
export function getNdbCheckupBins() { return load('ndb_checkup_bins'); }
export function getNdbCheckupRiskRatesStandardized() { return load('ndb_checkup_risk_rates_standardized'); }
export function getNdbCheckupStandardPop() { return load('ndb_checkup_standard_pop'); }
